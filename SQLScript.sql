...
CREATE TABLE `memberinfo` (
  ...
  `memNick` varchar(50) DEFAULT NULL,
  ...
  `memAge` int NOT NULL,
  `carbMin` decimal(5,2) NOT NULL,
  `carbMax` decimal(5,2) NOT NULL,
  `proteinMin` decimal(5,2) NOT NULL,
  `proteinMax` decimal(5,2) NOT NULL,
...
ADD COLUMN activityLevel ENUM('sedentary', 'lowactive', 'active', 'veryactive') NOT NULL AFTER memAge;

ALTER TABLE memberinfo 
MODIFY COLUMN carbMin INT NOT NULL,
MODIFY COLUMN carbMax INT NOT NULL,
MODIFY COLUMN proteinMin INT NOT NULL,
MODIFY COLUMN proteinMax INT NOT NULL,
MODIFY COLUMN fatMin INT NOT NULL,
MODIFY COLUMN fatMax INT NOT NULL;
