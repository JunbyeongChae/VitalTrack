      ...
      <div className="container mx-auto p-4">
        ...
        <div className="flex mb-4">
          ...
          <div className="w-1/4 pl-2">
            <button type="button" className="w-full p-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500" onClick={boardSearch}>
              검색
            </button>
          </div>
        </div>
        ...
        <div className="list-footer flex justify-center space-x-2 mt-4">
        <button className="p-2 bg-green-500 text-white rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400" onClick={() => navigate('/counsel/write')}>상담글쓰기</button>
        </div>
      </div>
    </>
  );
