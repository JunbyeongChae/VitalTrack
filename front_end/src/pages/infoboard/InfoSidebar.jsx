...
const InfoSidebar = ({ selectedCategory, onSelectCategory }) => {
  ...
  return (
    ...
    <div className="w-full md:w-1/4 h-auto md:min-h-[600px] md:max-h-screen md:overflow-y-auto bg-[#f2f5eb] p-6 rounded-xl shadow-lg border border-[#c2c8b0] mt-6 md:mt-0">
